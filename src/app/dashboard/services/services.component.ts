...
export class ServicesComponent implements OnInit {
    ...
    public serviceArray: ServiceCost[] = [];
    public staffArray: Staff[] = [];
    public staffSelected: Staff[]= [];


    public staffIds: string[]=[];
    public currentService = new ServiceCost(null, null, null, null);
...
addToArray(staff?: Staff){
    ...
    if (staff) {
        ...
        this.staffIds.indexOf(staff.id) === -1 ? this.staffIds.push(staff.id) && this.changeToHighlighted(staff) : this.removeFromList(staff.id) && this.changeToHighlighted(staff);
    console.log(this.staffIds);
...
removeFromList(key){
    var index = this.staffIds.indexOf(key, 0);
if (index > -1) {
