...
export class BookingsComponent implements OnInit {
    ...
    public dateDisplayed = "";
        ...
        public nineAm: boolean;
        public nine30Am: boolean;
        public tenAm: boolean;
        public ten30am: boolean;
        public elevenAm: boolean;
        public eleven30am: boolean;
        public twelveAm: boolean;
        public twelve30pm: boolean;
        public onePm: boolean;
        public one30pm: boolean;
        public twoPm: boolean;
        public two30pm: boolean;
        public threePm: boolean;
        public three30pm: boolean;
        public fourPm: boolean;
        public four30pm: boolean;
        public fivePm: boolean;
        public five30pm: boolean;
        public sixPm:boolean;
        public now: boolean;

    public staffArray: Staff[]  = [];
    public bookingArray0900: Bookings[] = [];
    public bookingArray0930: Bookings[] = [];
    public bookingArray1000: Bookings[] = [];
    public bookingArray1030: Bookings[] = [];
    public bookingArray1100: Bookings[] = [];
    public bookingArray1130: Bookings[] = [];
    public bookingArray1200: Bookings[] = [];
    public bookingArray1230: Bookings[] = [];
    public bookingArray1300: Bookings[] = [];
    public bookingArray1330: Bookings[] = [];
    public bookingArray1400: Bookings[] = [];
    public bookingArray1430: Bookings[] = [];
    public bookingArray1500: Bookings[] = [];
    public bookingArray1530: Bookings[] = [];
    public bookingArray1600: Bookings[] = [];
    public bookingArray1630: Bookings[] = [];
    public bookingArray1700: Bookings[] = [];
    public bookingArray1730: Bookings[] = [];
    public bookingArray1800: Bookings[] = [];
    public bookingArray1830: Bookings[] = [];
    public bookingArray1900: Bookings[] = [];
    public bookingArray1930: Bookings[] = [];
    public bookingArray2000: Bookings[] = [];

    public costSelected: number;
    public serviceSelected: string;
    public emailSelected: string;
    public customerName: string;
    public customerId: string;
    public staffIndex: string;
    public dateSelectedToBePassed: string;

    public daySelected = "Today";
    ...
    onChange(changedDate: string){
        ...
        this.sharedService.setDate(fullDate);
        this.getUser(fullDate);
