...
var BookingCashOutComponent = (function () {
    ...
    BookingCashOutComponent.prototype.cashOut = function () {
        ...
        if (this.alreadyBooked == true) {
            ...
            var newTransaction = new transaction_1.Transaction(epochTime, usableDate, this.notBookedForm.value["country"], this.notBookedForm.value["service"], this.customerId, Number(this.notBookedForm.value["costOfService"]), "Booking");
