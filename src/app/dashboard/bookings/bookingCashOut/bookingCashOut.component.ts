...
export class BookingCashOutComponent implements OnInit {
    ...
    public notBookedForm: FormGroup;
    // public modalDeleteUser = "bugModal";
    ...
    public isThereBookings: boolean;
    public customers: Customers[];
    public customerEmail = "";
    public expenditure: number;
    public customerNotes: string;

    public timeKeyTapped: string;
    public actualStringTime: string;
    
    public staffUID: string;

    public transaction: Transaction;
     
    public customer: Customers;
    public alreadyBooked: boolean;

    public costOfService = null;
    public bookingTime: string;

    // private service = "";
     

    public currentUser = new Customers(null, null, null, 0, 0, "No", null, [111111], null, [111111]);
    ...
    filterCountrySingle(event) {
     ...
     onChange(event: Customers){
        ...
        if (event.email != null)  {
            ...
            this.sharedService.setCustomerId(event.id);
    ...
    console.log(this.customerId);
     ...
     this.actualStringTime = booking.time;
     console.log("UUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUDUDUDUDUDUDDUDUDUDUDUDUDUDUDUUDUDUDDU");
...
// console.log(this.alreadyBooked);
    if (this.alreadyBooked == true){
        ...
        var newTransaction = new Transaction(epochTime, usableDate,this.notBookedForm.value["country"],this.notBookedForm.value["service"],this.customerId, Number(this.notBookedForm.value["costOfService"]), "Booking");
...
// console.log(this.staffUID, this.dateSelectedToBePassed,this.timeKeyTapped,"Aoife Rhatigan","Wash & Cut","qj4un","booked");
        ...
        // this.bookingService.updateBooking(this.staffUID, this.dateSelectedToBePassed,this.timeKeyTapped,"Aoife Rhatigan","Wash & Cut","qj4un","booked");
           console.log(this.timeKeyTapped);
        this.bookingService.updateBooking(this.staffUID, this.dateSelectedToBePassed,this.timeKeyTapped,this.notBookedForm.value["country"],this.notBookedForm.value["service"],this.customerId,"booked", this.actualStringTime);

        this.addUser(newTransaction);
        // this.customerId = "";
        this.customerEmail = "";
    this.timeKeyTapped = "";
    this.actualStringTime = "";
    }
