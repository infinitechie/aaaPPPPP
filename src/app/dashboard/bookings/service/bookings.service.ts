...
// user: Observable<firebase.User>;
    ...
    public staffSignedIn = this.fire.database.ref();
 ...
 updateBooking(staffMember: string,date:string,timeKey:string, customerName: string, serviceSelected: string, customerEmail: string, paid: string, actualTime: string) {
        const bookingRef = this.staffRef.child(staffMember).child("dates").child(date).child("times").child(timeKey);
        // console.log(user.id);
        // user.id = null;
        bookingRef.set({
            booked: paid,
