...
var BookingService = (function () {
    ...
    BookingService.prototype.grabUsersArray = function () {
        var _this = this;
    ...
    BookingService.prototype.changedListener = function () {
        var _this = this;
        return Observable_1.Observable.create(function (obs) {
    ...
    // }
    BookingService.prototype.updateBooking = function (staffMember, date, timeKey, customerName, serviceSelected, customerEmail, paid, actualTime) {
        var bookingRef = this.staffRef.child(staffMember).child("dates").child(date).child("times").child(timeKey);
        // console.log(user.id);
        // user.id = null;
        bookingRef.set({
            booked: paid,
    ...
    BookingService.prototype.getServiceCost = function () {
        var _this = this;
        return Observable_1.Observable.create(function (obs) {
    ...
    BookingService.prototype.getBookings = function (user, date) {
